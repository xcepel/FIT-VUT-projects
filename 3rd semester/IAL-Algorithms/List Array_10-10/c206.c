...
//	solved = FALSE; /* V případě řešení, smažte tento řádek! */
    ...
    while (elem) {
        DLLElementPtr next_elem = elem->nextElement;
        free(elem);
        elem = next_elem;
    }
    // Aktualizovat vsechny ukazatele
    list->firstElement = NULL;
    list->activeElement = NULL;
    list->lastElement = NULL;
}
...
//	solved = FALSE; /* V případě řešení, smažte tento řádek! */
    DLLElementPtr newElem = malloc(sizeof(*newElem));
    if (!newElem) {
        DLL_Error();
    } else {
        newElem->data = data;
        ...
        if (list->firstElement) { // List uz ma 1. element
            list->firstElement->previousElement = newElem;
        } else { // Do prazdneho seznamu
...
//	solved = FALSE; /* V případě řešení, smažte tento řádek! */
    ...
    if (!newElem) {
        ...
        if (list->lastElement) { // List uz ma 1. element
...
//	solved = FALSE; /* V případě řešení, smažte tento řádek! */
    if (list->firstElement) {
        ...
        if (list->firstElement == list->lastElement) { // v seznamu 1 prvek
            list->firstElement = NULL;
            list->lastElement = NULL;
        } else {
